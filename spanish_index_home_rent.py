...
provinces_grouped_df = df_provincias.drop_duplicates(['CPRO','LITPRO','CCA'])[['CPRO','LITPRO','CCA']].reset_index(drop=True)
...
data_provincias = df_provincias.drop(['LITPRO', 'CCA'], axis=1)
data_provincias
